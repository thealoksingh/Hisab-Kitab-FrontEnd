     ...
     <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center w-[80%]  ">
          ...
          <p className="text-lg justify-center  text-ellipsis text-gray-600 leading-relaxed">
            We are a team of three—<strong>Ravi Kumar</strong>, <strong>Alok singh</strong>,and <strong>Jaysingh Patel</strong>—who came together to build a simple yet powerful platform to manage financial transactions.
          ...
          <p className="text-lg  justify-center text-gray-600 text-ellipsis leading-relaxed mt-4">
        ...
        <div className="container mx-auto bg-gray-50 px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-2/3 w-full">
              <h6 className="text-sm text-gray-500 uppercase tracking-wide">Meet </h6>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Ravi Kumar</h2>
      ...
      <section id="section_2" className="py-16  bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-8">
            <div className="lg:w-2/3 w-full">
              <h6 className="text-sm text-gray-500 uppercase tracking-wide">Meet</h6>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Jaysingh Patel</h2>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">
               ...
               <span className='font-bold'>“Build with purpose. Code with clarity.”</span>
              ...
              <p className="font-semibold mt-2">Connect with me:</p>
               ...
               LinkedIn
                   ...
                   |
            <a href="https://github.com/Jaysingh2003" target="_blank" rel="noopener noreferrer" className="text-gray-800  underline">
           GitHub
           </a>
            </p>
            </div>
      ...
      <section id="section_3" className="py-16  bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-2/3 w-full">
              <h6 className="text-sm text-gray-500 uppercase tracking-wide">Meet</h6>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Alok Singh</h2>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">
                Throughout the project, I worked closely with Jaysingh on the frontend design and implementation, while also contributing to backend logic and integration. Our collaborative approach allowed us to brainstorm, iterate, and deliver features that aligned with both user expectations and technical efficiency.
                  ...
                  <span className='font-bold'>“Design is not just what it looks like—it’s how it works.”</span>
              </p>
              <div className="text-left">
              <p className="font-semibold mt-2">Connect with me:</p>
               <p className="space-x-2">
                <a href="https://www.linkedin.com/in/alok-singh-74963b24b/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
               LinkedIn
                   </a>
                   |
              <a href="https://github.com/thealoksingh" target="_blank" rel="noopener noreferrer" className="text-gray-800 underline">
              GitHub
             </a>
            </p>
            </div>
