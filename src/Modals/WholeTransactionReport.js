...
const WholeTransactionReport = ({isOpen,toggleModal}) => {
      ...
      <div className="main-form relative p-4 w-1/2 max-w-5xl flex gap-4 justify-center">
        <div className="form-signup shadow-inner-custom relative bg-white w-1/2 rounded-sm border border-gray-400 shadow dark:bg-gray-300">
          <div className="flex items-center justify-between p-2 md:p-2 rounded-sm bg-teal-600">
            ...
            <button
              type="button"
              className="text-gray-400 bg-transparent hover:bg-teal-200 hover:text-gray-900 rounded-sm text-sm w-6 h-6 ms-auto inline-flex justify-center items-center dark:hover:bg-teal-600 dark:hover:text-white"
              onClick={toggleModal}
            >
              <svg
                className="w-3 h-3"
          ...
          {/* <div className="profile h-12 w-full border border-gray-400 shadow-inner-custom bg-gray-200 p-5 flex items-center gap-1">
            <h1 className="text-white h-4 w-4 p-4 flex justify-center items-center rounded-full bg-indigo-600">A</h1>
            <h1 className="text-gray-800 h-4  p-5 flex justify-center items-center">Alok Singh</h1>
          </div> */}
          <form className="p-4 md:p-5">
            ...
            <div className="mb-2 mt-2">
              <button
                type="submit"
                className=" bg-teal-600  font-semibold text-white px-4 py-1 hover:bg-teal-500 focus:outline-none focus:ring-4 focus:ring-teal-300 shadow-md transition-all duration-300 ease-in-out transform hover:scale-105"
              >
                Download Report
              </button>
...
export default WholeTransactionReport;
