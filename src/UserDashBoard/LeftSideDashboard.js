...
function LeftSideDashBoard() {
  ...
  return (
    <>
      <div class="left-side  rounded bg-slate-200 w-[50%]  min-h-[100vh] relative overflow-hidden">
        <div class="left-upper h-[20%] bg-slate-300 w-[100%] relative">
          <div class="flex h-[30%] relative bg-slate-400">
            ...
            <div class="w-[30%] h-[100%] p-1">
              <button class="bg-rose-600 text-white font-bold py-1 px-4 rounded-[4px] flex items-center justify-center">
          ...
          <div class="flex h-[30%] relative">
            ...
            <div class="w-[35%] h-[100%] p-2 relative"></div>
            <div class="w-[30%] h-[100%] p-2 "></div>
          </div>
        </div>

        <div class="left-side-middle  min-h-64 bg-slate-100 w-[100%] relative">
    ...
    <thead className="sticky bg-gray-50 dark:bg-gray-700 text-xs text-gray-700 uppercase dark:text-gray-400">
     <tr>
        ...
        <div class="left-side-lower w-full  bottom-4 absolute h-[50px] flex items-center justify-center">
          <button
