...
const LogInForm2 = ({ isOpen, toggleModal }) => {
  isOpen = true;
      ...
      <div className="main-form relative p-4 w-1/2 max-w-5xl flex gap-4 justify-center">
        <div className="form2 relative bg-white w-1/2 rounded-sm shadow dark:bg-gray-300">
          ...
          <form className="p-4 md:p-5">
            ...
            <h5 className="text-rose-500 font-sm">!!! Incorrect Password or Number</h5>
              ...
              <input
                type="password"
                id="otp"
                className="w-[70%] input-field-shadow text-sm border border-gray-300 text-gray-600  rounded-sm p-1"
                placeholder="Enter Password"
                required
              />
              
            </div>
         <h5 className="text-cyan-600 font-sm">Forgot Password?</h5>
            ...
            <div className="mb-2 mt-1 flex gap-4">
              ...
              <span className="text-gray-800"> new user ? </span> <span className="text-sky-600"> SignUp </span>
            </div>
          </form>
        </div>
      </div>
